...
<tr>
<td>First Name:</td>
<td><input type="text" name="fname" value="Fisrt name" id="fname"></td>
</tr>
<tr>
<td>Last Name:</td>
<td><input type="text" name="lname" value="Last name" id="lname"></td>
</tr>
<tr>
<td>Age:</td>
...
<td><input type="text" name="cno" value="Number" id="cno"></td>
</tr>
<tr>
<td>E-mail Id:</td>
<td><input type="text" name="age" value="Age" id="age"></td>
